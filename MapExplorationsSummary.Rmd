...
For my smallest spatial aggregation unit, I'm using Census trackts. Previously, I was using blocks, but they were way too small. Essentially, they are *blocks* like the blocks on a street.
...
coordinates(streetlights) <- c("Latitude","Longitude")
